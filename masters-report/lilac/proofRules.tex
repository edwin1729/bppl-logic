...
When it comes to the proof rules of Lilac, the probability reasoning that can occur in the logic is predominantly present in two rules \texttt{wp\_unif} and
