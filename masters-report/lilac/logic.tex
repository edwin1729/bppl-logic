...
The alternative connective, $wp$, is constructed with the denotation of a program and only one LProp, the postcondition. Syntactically: $wp \llbracket M \rrbracket \{X. Q\}$.
