...
Because of this observation, I just want to state that it is strange I ended up not needing almost surely equals at all.
And I would want to try out more examples and implement full Lilac (with conditioning) before confirming if
