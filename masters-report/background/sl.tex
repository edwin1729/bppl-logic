...
model, from which there is a pre-determined construction of a BI (those connectives common to all separation logic). Given this Iris proof mode will be
