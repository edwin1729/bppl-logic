...
Finally, Proof Relevance separates the type theories of Lean and Rocq. Lean is Proof irrelevant meaning terms of types of Prop, are definitionally 
equal\footnote{Rocq on the other hand is proof relevant by default. However, after noticing that Lean's proof relevance being indispensable for some projects,
